...
import { BsFacebook, BsLinkedin, BsPerson, BsTwitter } from "react-icons/bs";
...
const Contact = () => {
  const { hasCopied, onCopy } = useClipboard("iftikharntm@gmail.com");
  ...
  return (
    <>
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 16 }}>
              ...
              >
                ...
                <Text pt={4} fontSize={"md"}>
                  +2348034030638 | iftikharntm@gmail.com
                </Text>
              </Heading>
      ...
      {/* <Container>
        <Box>
          <Text>Love to hear from you,</Text>
